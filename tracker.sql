SELECT  
    ...
    -- ,CASE fleet_order.order_type
    --     WHEN 0 THEN 'Shopee Express (WH)'
    --     WHEN 1 THEN 'CB'
    --     WHEN 2 THEN 'Marketplace'
    --     WHEN 6 THEN 'Marketplace - Dropoff'
    --     WHEN 7 THEN 'Bulky Shopee Express (WH)'
    --     WHEN 8 THEN 'Bulky Marketplace'
    --     WHEN 9 THEN 'Marketplace - Dropoff'
    --     WHEN 12 THEN 'Non-Shopee Marketplace'
    --     ELSE 'other'
    -- END AS order_type
